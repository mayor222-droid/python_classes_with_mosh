    ...
    def __init__(self, letter):
        ...
        def get_move(self,game):
            ...
            while not valid_square:
                 ...
                 try:
                      val = int(square)
                      if val not in game.available_movea():
                           raise ValueError
                      valid_square = True
                 except ValueError:
...
class GeniusComputerPlayer(player):
     ...
     def minimax(self, state, player):
          ...
          if player == max_player:
               best = {'position': None, 'score': -math.inf} # each score should maximize (be integer)
          else:
          ...
          for possible_move in state.available_moves():
               ...
               # step 2: recurse using minimize to stimulate a game after making that move
               ...
               if player == max_player: # we are trying to miximize the max_player
